...
{
    public class CreatePlanTripModel
    {
        public PlanTripForCreatePlanTrip PlanTrip { get; set; }
        public List<PlanTripProspectCreateModel> ListProspect { get; set; }

        public class PlanTripProspectCreateModel
        {
            public List<PlanTripTaskForCreatePlanTrip> ListTask { get; set; }
    ...
    public class PlanTripTaskForCreatePlanTrip
    {
    ...
    public class PlanTripForCreatePlanTrip
    {
